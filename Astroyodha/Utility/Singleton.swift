...
class Singletion {
    ...
    func compareDate(date: Date) -> BookingFilter {
        ...
        let startDate = convertStringToDate(strDate: self.convertDateFormate(date: date, currentFormate: datePickerSelectedFormat, outputFormat: datePickerDateFormatWithoutDash), outputFormate: datePickerDateFormatWithoutDash)
